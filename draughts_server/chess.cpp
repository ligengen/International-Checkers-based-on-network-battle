...
void Chess::paintEvent(QPaintEvent *ev)
{
    ...
    {
        QPixmap pp;
        pp.load("/Users/ligen/Desktop/QT/draughts_server/resource/black.png");
        p.drawPixmap(5,5,30,30,pp);
    }
    else if(status == 2)
    {
        QPixmap pp;
        pp.load("/Users/ligen/Desktop/QT/draughts_server/resource/white.png");
        p.drawPixmap(5,5,30,30,pp);
    }
    else if(status == -2)
    {
    ...
    {
        QPixmap pp;
        pp.load("/Users/ligen/Desktop/QT/draughts_server/resource/black_queen.png");
        p.drawPixmap(5,5,30,30,pp);
    }
    if(chosen)
    {
...
void Chess::setStatusValue(int a)
{
    status = a;
}
